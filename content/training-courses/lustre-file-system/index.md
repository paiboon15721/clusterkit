...
## รูปแบบการสอน
- หลักสูตรเรียนแบบ online บรรยาย และปฏิบัติการผ่านซอฟต์แวร์ Zoom จำลอง VM ในเครื่องคอมพิวเตอร์ของท่าน และจำลองสภาพแวดล้อมแบบคลัสเตอร์บน Cloud (ทางบริษัทฯ จัดเตรียมให้)
- หลักสูตรเรียนแบบ onsite บรรยายและปฏิบัติการที่บริษัทฯ จำลอง VM ในเครื่องคอมพิวเตอร์ของท่าน  และจำลอง VM จำนวน 6 โหนดบนเครื่องคอมพิวเตอร์ที่ทางบริษัทฯ จัดเตรียมให้

## สิ่งที่ผู้เข้าอบรมต้องเตรียม

ผู้เข้าอบรมต้องเตรียมเครื่องคอมพิวเตอร์ที่มีหน่วยความจำ(RAM) ไม่ต้องกว่า 8GB และมีพื้นที่ว่าง (Disk space) ไม่น้อยกว่า 100GB พร้อมติดตั้ง VirtualBox และ VirtualBox Extension Pack และเปิดฟังก์ชั่น Virtualization, Hyperthreading ใน BIOS ให้เรียบร้อยตาม{{< link url="http://www.clusterkit.co.th/training/pdf/VirtualBox_64bit_Problem.pdf" text="คู่มือ " >}} 
